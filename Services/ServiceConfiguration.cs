...
namespace VAuto.Services
{
    ...
    public static class ServiceConfiguration
    {
        ...
        public class ArenaBuildConfig
        {
            ...
            public bool EnableBuildValidation { get; set; } = true;
            public bool EnablePreviewMode { get; set; } = false;
            public bool EnableUndoSystem { get; set; } = true;
            public int MaxUndoSteps { get; set; } = 50;
            public bool EnableCollaboration { get; set; } = false;
            public bool EnableBuildTemplates { get; set; } = true;
            public Dictionary<string, BuildTemplate> BuildTemplates { get; set; } = new();
            public bool EnableCostCalculation { get; set; } = true;
            public bool EnableResourceTracking { get; set; } = true;
            public int MaxResourcesPerStructure { get; set; } = 100;
            public bool EnableBuildEffects { get; set; } = true;
            public bool EnableSnapshots { get; set; } = true;
            public int MaxSnapshotsPerStructure { get; set; } = 10;
            public bool EnableSharing { get; set; } = false;
            public bool EnableImportExport { get; set; } = true;
            public List<string> AllowedStructureTypes { get; set; } = new();
            public List<string> RestrictedStructureTypes { get; set; } = new();
            public bool EnablePermissions { get; set; } = true;
            public Dictionary<string, PermissionLevel> PermissionLevels { get; set; } = new();
            public bool EnableLogging { get; set; } = true;
            public bool EnableMetrics { get; set; } = true;
            public int MaxBuildQueueSize { get; set; } = 10;
            public bool EnableParallelBuilding { get; set; } = false;
            public bool EnableAutoRepair { get; set; } = true;
            public float MinBuildDistance { get; set; } = 2.0f;
            public bool EnableTerrainValidation { get; set; } = true;
            public bool EnableWeatherEffects { get; set; } = false;
            public List<string> DefaultMaterials { get; set; } = new();
            public Dictionary<string, int> MaterialLimits { get; set; } = new();
            public bool EnableQualityControl { get; set; } = true;
            public int MaxQualityLevel { get; set; } = 5;
            public bool EnableBlueprintSystem { get; set; } = true;
            public Dictionary<string, BlueprintConfig> Blueprints { get; set; } = new();
            public bool EnablePrefabIntegration { get; set; } = true;
            public Dictionary<string, PrefabConfig> Prefabs { get; set; } = new();
            public bool EnableVersionControl { get; set; } = true;
            public Dictionary<string, VersionConfig> StructureVersions { get; set; } = new();
            ...
            public Dictionary<string, RestoreConfig> RestoreOptions { get; set; } = new();
            public bool EnableValidation { get; set; } = true;
            public List<string> ValidationRules { get; set; } = new();
            public bool EnableAnalytics { get; set; } = true;
            public Dictionary<string, AnalyticsConfig> AnalyticsData { get; set; } = new();
            public bool EnableNotifications { get; set; } = true;
            public Dictionary<string, NotificationConfig> NotificationSettings { get; set; } = new();
            public bool EnableDebugMode { get; set; } = false;
            public Dictionary<string, DebugConfig> DebugOptions { get; set; } = new();
            public bool EnableExperimentalFeatures { get; set; } = false;
            public List<string> ExperimentalFeatures { get; set; } = new();
            public bool EnablePerformanceMonitoring { get; set; } = true;
            public Dictionary<string, PerformanceConfig> PerformanceMetrics { get; set; } = new();
            public bool EnableHotReload { get; set; } = true;
            public int HotReloadIntervalSeconds { get; set; } = 10;
            public bool EnableSecurity { get; set; } = true;
            public Dictionary<string, SecurityConfig> SecuritySettings { get; set; } = new();
            public List<string> AllowedUsers { get; set; } = new();
            public List<string> BannedUsers { get; set; } = new();
            public Dictionary<string, AccessLevel> UserAccessLevels { get; set; } = new();
            public bool EnableRateLimiting { get; set; } = true;
            public Dictionary<string, RateLimitConfig> RateLimits { get; set; } = new();
            public bool EnableAuditLog { get; set; } = true;
            public string AuditLogPath { get; set; } = "VAuto/BuildAudit.log";
            public int MaxAuditEntries { get; set; } = 1000;
            public bool EnableIntegration { get; set; } = true;
            public Dictionary<string, IntegrationConfig> IntegrationSettings { get; set; } = new();
            public List<string> IntegratedServices { get; set; } = new();
            public bool EnableAPI { get; set; } = true;
            public Dictionary<string, APIConfig> APISettings { get; set; } = new();
            public List<string> APIEndpoints { get; set; } = new();
            public bool EnableDocumentation { get; set; } = true;
            public Dictionary<string, DocumentationConfig> DocumentationSettings { get; set; } = new();
            public bool EnableTesting { get; set; } = true;
            public Dictionary<string, TestingConfig> TestingSettings { get; set; } = new();
            public List<string> TestSuites { get; set; } = new();
            public bool EnableProfiling { get; set; } = false;
            public Dictionary<string, ProfilingConfig> ProfilingSettings { get; set; } = new();
        }
