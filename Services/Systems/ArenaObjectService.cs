...
namespace VAuto.Services.Systems
{
    ...
    /// </summary>
    public static class ArenaObjectService
    {
        private static bool _initialized = false;
        private static readonly Dictionary<Entity, ArenaObjectData> _arenaObjects = new();
        private static readonly Dictionary<string, List<Entity>> _objectsByArena = new();
        ...
        public static bool AddObjectToArena(Entity entity, string arenaId, ArenaObjectType type, string name)
        {
            try
            {
        ...
        public static bool RemoveObjectFromArena(Entity entity)
        {
            try
            {
        ...
        public static bool MoveObject(Entity entity, float3 newPosition, quaternion? newRotation = null)
        {
            try
            {
                if (entity == Entity.Null)
        ...
        public static bool SetObjectActive(Entity entity, bool isActive)
        {
            try
            {
                if (entity == Entity.Null)
        ...
        public static bool SetObjectProperty(Entity entity, string propertyName, object value)
        {
            try
            {
        ...
        public static object GetObjectProperty(Entity entity, string propertyName)
        {
            try
            {
                if (entity == Entity.Null || string.IsNullOrEmpty(propertyName))
        ...
        public static bool MoveAllObjectsFromArena(string arenaId, float3 offset)
        {
            try
            {
        ...
        public static bool RemoveAllObjectsFromArena(string arenaId)
        {
            try
            {
                if (string.IsNullOrEmpty(arenaId))
        ...
        public static List<ArenaObjectData> GetAllArenaObjects()
        {
            lock (_lock)
            {
        ...
        public static List<ArenaObjectData> GetArenaObjects(string arenaId)
        {
            lock (_lock)
            {
                if (_objectsByArena.TryGetValue(arenaId, out var arenaObjects))
        ...
        public static List<ArenaObjectData> GetObjectsByType(ArenaObjectType type)
        {
            lock (_lock)
            {
                var typeName = type.ToString();
        ...
        public static ArenaObjectData GetObjectData(Entity entity)
        {
            lock (_lock)
            {
        ...
        public static List<ArenaObjectData> GetObjectsInRange(float3 center, float radius)
        {
            lock (_lock)
            {
        ...
        public static List<ArenaObjectData> GetActiveObjects()
        {
            lock (_lock)
            {
        ...
        public static int GetObjectCountByArena(string arenaId)
        {
            lock (_lock)
            {
        ...
        public static int GetObjectCountByType(ArenaObjectType type)
        {
            lock (_lock)
            {
                var typeName = type.ToString();
