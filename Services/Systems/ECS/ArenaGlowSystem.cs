...
namespace VAuto.Services.ECS
{
    ...
    public partial struct ArenaGlowSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            try
            {
                if (!ArenaGlowService.IsInitialized)
                    return;
        ...
        private static void UpdateDynamicGlowEffects(double time, float deltaTime)
        {
            try
            {
                ...
                foreach (var glowName in activeGlows)
                {
                    ...
                    {
                        case ArenaGlowService.GlowType.Circular:
                            UpdateCircularGlow(glowData, time, deltaTime);
                            break;
                            
                        case ArenaGlowService.GlowType.Boundary:
                            UpdateBoundaryGlow(glowData, time, deltaTime);
                            break;
                            
                        case ArenaGlowService.GlowType.Point:
                            UpdatePointGlow(glowData, time, deltaTime);
                            break;
                            
                        case ArenaGlowService.GlowType.Linear:
                            UpdateLinearGlow(glowData, time, deltaTime);
                            break;
                            
                        case ArenaGlowService.GlowType.Area:
        ...
        private static void UpdateCircularGlow(ArenaGlowService.GlowData glow, double time, float deltaTime)
        {
            try
            {
        ...
        private static void UpdateBoundaryGlow(ArenaGlowService.GlowData glow, double time, float deltaTime)
        {
            try
            {
        ...
        private static void UpdatePointGlow(ArenaGlowService.GlowData glow, double time, float deltaTime)
        {
            try
            {
        ...
        private static void UpdateLinearGlow(ArenaGlowService.GlowData glow, double time, float deltaTime)
        {
            try
            {
        ...
        private static void UpdateAreaGlow(ArenaGlowService.GlowData glow, double time, float deltaTime)
        {
            try
            {
    ...
    public partial struct ArenaGlowEntitySystem : ISystem
    {
        ...
        private static void AddGlowRenderComponents(ref EntityCommandBuffer ecb, Entity entity, ArenaGlowService.GlowData glowData)
        {
            ...
            if (glowData.Type == ArenaGlowService.GlowType.Point)
            {
    ...
    public struct GlowComponent : IComponentData
    {
        ...
        public ArenaGlowService.GlowType GlowType;
    }
}