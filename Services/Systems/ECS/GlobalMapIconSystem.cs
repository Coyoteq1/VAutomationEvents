...
namespace VAuto.Services.Systems.ECS
{
    ...
    public partial struct GlobalMapIconSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            try
            {
                ...
                // Update the service with delta time for timing control
                GlobalMapIconService.Update(deltaTime);
        ...
        private static void UpdatePlayerLocations()
        {
            try
            {
                // ECS query iteration isn't available in our stubbed build; delegate to service.
    ...
    public partial struct MapIconLifecycleSystem : ISystem
    {
        ...
        public void OnDestroy(ref SystemState state)
        {
            // Cleanup lifecycle manager registration
        }
    }
