...
namespace VAuto.Services
{
    ...
    public static class CharacterSwapService
    {
        ...
        private static LifecycleService GetLifecycleService() => ServiceManager.GetService<LifecycleService>();
        ...
        private static bool SwitchToArenaCharacter(ulong platformId, Entity userEntity, DualCharacterState state)
        {
            try
            {
                ...
                CharacterFreezeService.Unfreeze(userEntity, state.ArenaCharacter);
                ...
                FastTeleport(state.ArenaCharacter, arenaSpawnPos);
                ...
                GetLifecycleService()?.EnterArena(userEntity, state.ArenaCharacter, "default_arena");
        ...
        private static bool SwitchToNormalCharacter(ulong platformId, Entity userEntity, DualCharacterState state)
        {
            try
            {
                ...
                FastTeleport(state.NormalCharacter, state.LastNormalPosition);
                ...
                // Notify lifecycle system
                GetLifecycleService()?.ExitArena(userEntity, state.ArenaCharacter);
