...
namespace VAuto.Commands.Dev
{
    ...
    public static class AnalyticsCommands
    {
        ...
        private static int GetPlayerActivityScore(PlayerData player) => new System.Random().Next(10, 100);
        private static float CalculateRetentionRate() => 78.5f + new System.Random().Next(-10, 15);
            ...
            public static MonitoringReport Stop(string monitorType)
            {
                if (_sessions.TryGetValue(monitorType, out var session))
                {
                    ...
                    var report = new MonitoringReport
                    {
                        ...
                        SampleCount = new System.Random().Next(50, 200),
                        AverageFPS = 58.5f + new System.Random().Next(-10, 10),
                        PeakMemoryMB = 850 + new System.Random().Next(-100, 200),
                        IssueCount = new System.Random().Next(0, 5)
                    };
