...
namespace VAuto.Commands
{
    ...
    public static class DevDebugCommands
    {
        ...
        public static void EntityCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in entity command {action}: {ex.Message}");
        ...
        public static void MemoryCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in memory command {action}: {ex.Message}");
        ...
        public static void PerfCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in perf command {action}: {ex.Message}");
        ...
        public static void NetworkCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in network command {action}: {ex.Message}");
        ...
        public static void ECSCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in ecs command {action}: {ex.Message}");
        ...
        public static void LogCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in log command {action}: {ex.Message}");
        ...
        public static void TestCommand(ChatCommandContext ctx, string action, string args = "")
        {
            ...
            {
                Plugin.Instance.Log?.LogError($"Error in test command {action}: {ex.Message}");
        ...
        private static void LogLevelCommand(ChatCommandContext ctx, string args) => ctx_reply("Log level - Feature not implemented");
        private static void LogFilterCommand(ChatCommandContext ctx, string args) => ctx_reply("Log filter - Feature not implemented");
