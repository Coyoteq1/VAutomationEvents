...
namespace VAuto.Extensions
{
    ...
    public static class ECSExtensions
    {
        ...
        public static Entity CreateEntityWithComponents(EntityManager entityManager, params (ComponentType componentType, object componentData)[] components)
        {
            try
            {
                ...
                {
                    entityManager.AddComponentData(entity, componentType, componentData);
                }
                return entity;
            }
            catch (Exception ex)
    ...
    #region Unity Types Aliases
    /// <summary>
    /// Aliases for common Unity/VRising types to avoid naming conflicts
    /// </summary>
    public static class UnityTypes
    {
        ...
        public struct PrefabGUID
        {
            ...
            public PrefabGUID(System.Guid guid)
            {
                Guid = guid;
            }
            
            public static implicit operator PrefabGUID(System.Guid guid) => new PrefabGUID(guid);
            public static implicit operator System.Guid(PrefabGUID prefab) => prefab.Guid;
        }
