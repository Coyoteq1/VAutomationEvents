...
namespace VAuto.Core
{
    ...
    public static class Core
    {
        ...
        internal static void InitializeAfterLoaded()
        {
            ...
            MissingServices.ArenaUpdateSystem.Initialize();
            ...
            MissingServices.ArenaDatabaseService.Initialize();
        ...
        /// <summary>
        /// Safe entity add component (KindredSchematics pattern)
        /// </summary>
        ...
        /// <summary>
        /// Safe entity write component (KindredSchematics pattern)
        /// </summary>
